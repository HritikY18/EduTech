    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">EduTech Teacher</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Payment Requests:</h6>
                        <a class="collapse-item" href="{{ route('teacher.paymentRequests') }}">Payment Requests</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#certificate"
                    aria-expanded="true" aria-controls="certificate">
                    <i class="fas fa-fw fa-book"></i>
                    <span>Certificates</span>
                    
                </a>
                <div id="certificate" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Certificate Requests:</h6>
                        <a class="collapse-item" href="{{ route('teacher.certificateRequests') }}">Certificate Requests</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  ...
                  <a class="dropdown-item" href="{{route('user.changePassword',auth()->user())}}">
